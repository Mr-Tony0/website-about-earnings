...
<html>
<head>
	<title>Топ фриланс бирж для начинающих в России, лучшие площадки для заработка</title>
	<meta name="description" content="Список лучших бирж фриланса для работы на дому, расскажем как организовать заработок в интернете новичку без опыта на фриланс площадках бесплатно">
	<meta charset = "utf-8">
...
<form method="POST" action=<?php echo $_SERVER['PHP_SELF'];?> enctype="multipart/form-data">
	...
	<section class="container">
		<div class="text katalog-text">
			<h1 class="text__title">Как заработать на фрилансе</h1>
			<p class="text__descript">
				Фриланс может избавить вас от приевшейся повседневной работы в офисе.
				Такой вид деятельности как фриланс будет полезен всем кто желает зарабатывать в интернете.
				Что бы начать работать на фрилансе, необходимо выбрать правильную площадку, с чем мы вам и поможем.
				В нашем списке представлены различные бесплатные фриланс площадки.
				Мы позаботились и о новичках в заработке на фрилансе и подготовили лучшие биржи для начинающих.
				С нами вам не придется долго выбирать подходящую биржу, у нас вы найдете топовые Российские и зарубежные биржи для продуктивного заработка в интернете.
			</p>
		</div>
		<center>
		...
		<div class="content">
			...
			<?php
				...
				$state = mysqli_query($conect,"SELECT `name`, `image`, `title-katalog`, `description-katalog`, `money-level`, `hard-level`, `type` FROM `post` WHERE `freelance` = 'on'");
