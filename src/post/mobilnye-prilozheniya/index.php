...
<html>
<head>
	<title>Приложения для заработка денег в интернете на телефон андроид или айфон,с выводом</title>
	<meta name="description" content="Если вы владелец телефона, айфон или андроид, значит у вас есть возможность зарабатывать деньги в интернете с помощью мобильных приложений">
	<meta charset = "utf-8">
...
<form method="POST" action=<?php echo $_SERVER['PHP_SELF'];?> enctype="multipart/form-data">
	...
	<section class="container">
		<div class="text katalog-text">
			<h1 class="text__title">Бесплатные приложения для заработка денег в интернете</h1>
			<p class="text__descript">
				Для тех кто хочет начать зарабатывать деньги в интернете, отличным выбором станет заработок на мобильных приложениях.
				Как происходит процесс получение прибыли?
				Вы скачиваете приложение на свой телефон, неважно андроид или айфон, затем выполняете определенные действия и получаете свою прибыль.
				Таким образом можно обеспечить себе дополнительным или даже основным источником дохода в интернете.
				Мы подробно объясним, как и что нужно делать что бы обеспечить себе заработок в интернете на своем телефоне.
			</p>
		</div>
		<center>
