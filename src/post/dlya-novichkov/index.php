...
<html>
<head>
	<title>Как заработать в интернете новичку, заработок денег для начинающих с нуля</title>
	<meta name="description" content="Мы поделимся с вами способами заработка в интернете для новичков и начинающих, расскажем как реально начать зарабатывать у себя дома">
	<meta charset = "utf-8">
...
<form method="POST" action=<?php echo $_SERVER['PHP_SELF'];?> enctype="multipart/form-data">
	...
	<section class="container">
		<div class="text katalog-text">
			<h1 class="text__title">Заработок в интернете для новичка</h1>
			<p class="text__descript">
				Многие пользователи интернета задаются вопросом, как заработать деньги у себя дома новичку с нуля?
				В текущий момент времени заработок в интернете резко набирает популярность, но не осведомленному пользователю сложно найти что-то подходящее,
				не опытные пользователи часто сталкиваются с мошенниками, теряя свое время и деньги
				Что бы решить эту проблему мы составили список различных способов как дополнительного,
				так и основного заработка для тех кто начинает работать в интернете, где вы сможет реально заработать деньги в интернете.
				Просмотрев наши статьи вы узнаете как можно работать и зарабатывать в глобальной сети интернет не только опытному пользователю, 
				но и новичку не покидая своего дома и сможете быстро начать зарабатывать деньги в интернете с нуля.
			</p>
		</div>
		<center>
