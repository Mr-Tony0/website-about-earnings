...
<html>
<head>
	<title>Свой сайта для заработка денег, как создать сайт в интернете с нуля бесплатно</title>
	<meta name="description" content="Один из способов для заработка денег в интернете, это создание своего сайта самому с нуля. Вы узнаете как и какой сайт создать для заработка бесплатно">
	<meta charset = "utf-8">
...
<form method="POST" action=<?php echo $_SERVER['PHP_SELF'];?> enctype="multipart/form-data">
	...
	<section class="container">
		<div class="text katalog-text">
			<h1 class="text__title">Создание сайта для заработка денег</h1>
			<p class="text__descript">
				Многие пользователи интернета желают создать свой сайт,
				Но не каждый обладает навыками программированиями.
				Для таких пользователей мы хотим предложить способы заработать на своем сайте в интернете бесплатно.
				С помощью бесплатных конструкторов вы сможете сами создать сайт для заработка с нуля.
				Если вы еще не определились какой сайт создать для заработка, то мы поможем определиться с тематикой и Монетизировать сайт.
			</p>
		</div>
		<center>
		...
		<div class="content">
			...
			<?php
				...
				$state = mysqli_query($conect,"SELECT `name`, `image`, `title-katalog`, `description-katalog`, `money-level`, `hard-level`, `type` FROM `post` WHERE `site` = 'on'");
