...
<html>
<head>
	<title>Интернет заработок в социальных сетях, заработок денег на соц сетях.</title>
	<meta name="description" content="Заработок на популярных социальных сетях таких как вк, инистаграмм и другие, расскажем как заработать деньги в соц. сетях">
	<meta charset = "utf-8">
...
<form method="POST" action=<?php echo $_SERVER['PHP_SELF'];?> enctype="multipart/form-data">
	...
	<section class="container">
		<div class="text katalog-text">
			<h1 class="text__title">Заработок в интернете в социальных сетях</h1>
			<p class="text__descript">
				В соц. сетях можно не только заниматься просмотром ленты, но и заработком.
				Для работы в социальных сетях вам понадобиться завести там аккаунт, 
				после чего начать зарабатывать деньги.
			</p>
		</div>
		<center>
